...
def create_pano(
    ...
    wrap_list = utils.ProjectImages( #ransacHomography
...
def main():
    ...
    image_list = ['fountain4', 'fountain0'] # size 1125/1500
    image_list = ['garden4', 'garden0', 'garden3'] # size 1125/1500
    image_list = ['irving_out3', 'irving_out6', 'irving_out5'] # size 1125/1500
   
    #image_list = ['Rainier1', 'Rainier2', 'Rainier3','Rainier4','Rainier5','Rainier6'] #size 600/1000
    #image_list = ['garden_up4', 'garden_up5', 'garden_up6'] # size 1125/1500
    num_iter = 50
    tol = 10
    ratio_thres = 0.9
